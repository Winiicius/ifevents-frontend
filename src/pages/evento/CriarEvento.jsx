...
function CriarEvento() {
    ...
    const onSubmit = async (data) => { // adicionar o email do criador na lista dos organizadores antes de fazer a requisição
        const evento = {
    ...
    return <div className="h-full w-full bg-gray-300">
        <div className="justify-center items-center w-full md:w-3/4 lg:w-3/4 mx-auto shadow-md pt-2">
            ...
            <div className="mt-3 w-full mx-auto p-10 bg-white rounded-lg shadow-md">
                <form onSubmit={handleSubmit(onSubmit)} className="w-3/4 mx-auto p-6 bg-white shadow-2xl rounded-lg space-y-4">
                    <FormInput
